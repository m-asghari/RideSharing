...
set xtics   ("3min" 1, "6min" 2, "9min" 3, "12min" 4, "15min" 5, "20min" 6)
...
set output 'mwt_rev.eps'
plot [0.6:6.5] 'wait_time2profit.txt' using ($1/1000000) ti 'APART' ls 1 fs pattern 1, \
'' using ($2/1000000) ti 'NN' ls 5 fs pattern 3, \
'' using ($3/1000000) ti 'TREE' ls 3 fs pattern 4
clear
