...
set yrange [0:100]
set ylabel 'More Availability (%)' offset 2
set output 'availability.eps'
plot [0.6:2.5] 'availability.txt' using ($1) ti 'NN' ls 5 fs pattern 3, \
