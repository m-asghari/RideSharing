...
set xtics  ("APART" 1.02, "TREE" 1.25)
...
set yrange [0:40]
set ylabel 'Revenuse ($ thousands) ' offset 2
set output 'tkde_rev.eps'
plot [0.8:1.4] 'tkde_rev.txt' using ($1) ti 'APART' ls 1 fs pattern 1, \
'' using ($2) ti 'TREE' ls 3 fs pattern 4
clear
